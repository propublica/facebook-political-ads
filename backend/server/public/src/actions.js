...
export const getOneAd = (ad_id, url = "https://dashboard-backend.qz.ai/pp/ads") => {
...
export const getGroupedAttrs = (
  ...
  recent = "by",
  root_url = "https://dashboard-backend.qz.ai/pp/ads"
) => {
...
export const getAdminSummary = (root_url = "https://dashboard-backend.qz.ai/pp/ads") => {
...
export const getHomepageSummary = (root_url = "https://dashboard-backend.qz.ai/pp/ads") => {
...
export const getAds = (url = "https://dashboard-backend.qz.ai/pp/ads") => {
  return (dispatch, getState) => {
    let state = getState();
    ...
    if (state.persona) {
      ...
      url = "https://dashboard-backend.qz.ai/pp/persona";
